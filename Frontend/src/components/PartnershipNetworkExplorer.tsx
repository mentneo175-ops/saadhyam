...
function BusinessNode({ data }: any) {
  return (
    <div className="relative group">
      ...
      {/* Node content */}
      <div className="relative bg-white rounded-3xl p-8 shadow-2xl border-2 border-purple-200 min-w-[280px]">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-1 break-words max-w-[240px]">
              {data.name}
            </h3>
...
function InfluencerNode({ data }: any) {
  ...
  return (
    ...
    >
      ...
      {/* Node content */}
      <div
        className="relative bg-white backdrop-blur-sm rounded-2xl p-5 shadow-xl border-2 transition-all hover:scale-105"
        style={{
      ...
      >
        <div className="flex flex-col items-center gap-3">
          ...
          {/* Name */}
          <div className="text-center">
            <p className="text-sm font-bold text-gray-900 truncate max-w-[130px]">
        ...
        {/* Hover tooltip */}
        {showTooltip && (
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 w-56 bg-gray-900 text-white rounded-xl p-4 shadow-2xl z-50 animate-fadeIn pointer-events-none">
...
export default function PartnershipNetworkExplorer({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-purple-50 via-white to-pink-50 md:relative md:inset-auto md:z-auto">
      {/* Header */}
      <div className="absolute top-0 left-0 right-0 z-10 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm md:relative">
        <div className="flex items-center justify-between max-w-7xl mx-auto px-6 py-4">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-xl bg-gray-100 hover:bg-gray-200 transition-colors md:hidden"
          >
      ...
      {selectedInfluencer && (
        <div className="fixed md:absolute right-0 top-0 bottom-0 w-full md:w-96 bg-white border-l border-gray-200 shadow-2xl overflow-y-auto animate-slideInRight z-20">
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-gray-700">{selectedInfluencer.location}</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <TrendingUp className="w-4 h-4 text-purple-500" />
                <span className="text-gray-700">{selectedInfluencer.platform}</span>
              </div>
            </div>
