...
function YouTubeDashboard() {
  ...
  const tourStepsConfig = [
    {
      id: "tour-youtube-profile",
      title: "YouTube Connection",
      heading: "1. Channel Settings",
      desc: "Connect your YouTube Channel, monitor channel details, or disconnect integrations if needed.",
      indicator: 1
    },
    {
      id: "tour-youtube-kpis",
      title: "Performance KPI Cards",
      heading: "2. Channel Performance Metrics",
      desc: "View live subscriber counts, total views, watch times, and like metrics at a glance.",
      indicator: 2
    },
    {
      id: "tour-youtube-tabs",
      title: "YouTube Tools",
      heading: "3. Creator Tools & Analytics",
      desc: "Upload new videos, monitor scheduled releases, view library content, or inspect analytics data.",
      indicator: 3
    }
  ];
  ...
  useEffect(() => {
    const isCompleted = localStorage.getItem("saadhyam_tour_youtube_completed");
    if (!isCompleted) {
  ...
  if (!isConnected) {
    return (
      <div className="p-4 md:p-6 lg:p-8 space-y-6 w-full max-w-5xl mx-auto flex flex-col justify-center min-h-[70vh]">
        ...
        <Card id="tour-youtube-profile" className="border border-purple-100 dark:border-slate-800 shadow-xl shadow-purple-50/20 dark:shadow-none max-w-xl mx-auto w-full overflow-hidden bg-white/70 dark:bg-slate-950/40 backdrop-blur-sm">
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-6 w-full max-w-full mx-auto">
      ...
      <div className="flex items-start md:items-center justify-between gap-4">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-green-50 border border-green-200 rounded-full dark:bg-green-950/20 dark:border-green-900/30">
            ...
            <Button
              ...
              className="border-purple-200 hover:bg-purple-50 text-purple-700 dark:border-purple-900/40 dark:text-purple-400 dark:hover:bg-purple-950/30"
              title="Sync all data"
            >
      ...
      {/* KPI Stats Row */}
      <div id="tour-youtube-kpis" className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        <Card className="border border-purple-100/80 shadow-xs bg-white dark:bg-slate-900 dark:border-slate-800/80">
          <CardContent className="p-5 flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-purple-50 flex items-center justify-center text-purple-600 shrink-0 dark:bg-purple-950/30 dark:text-purple-400">
        ...
        <Card className="border border-purple-100/80 shadow-xs bg-white dark:bg-slate-900 dark:border-slate-800/80">
          <CardContent className="p-5 flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 shrink-0 dark:bg-indigo-950/30 dark:text-indigo-400">
        ...
        <Card className="border border-purple-100/80 shadow-xs bg-white dark:bg-slate-900 dark:border-slate-800/80">
          <CardContent className="p-5 flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-pink-50 flex items-center justify-center text-pink-600 shrink-0 dark:bg-pink-950/30 dark:text-pink-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-8 xl:col-span-9 space-y-6">
          ...
          >
            <TabsList className="bg-slate-100/80 border border-slate-200/50 p-1 rounded-xl w-full max-w-md flex dark:bg-slate-950/40 dark:border-slate-800">
              {TABS.map(({ id, label, Icon }) => (
                <TabsTrigger
                  key={id}
                  value={id}
                  className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-semibold transition-all data-[state=active]:bg-white data-[state=active]:text-purple-700 data-[state=active]:shadow-xs text-slate-600 hover:text-slate-900 focus-visible:outline-hidden dark:data-[state=active]:bg-slate-800 dark:data-[state=active]:text-purple-400 dark:text-slate-400 dark:hover:text-slate-200"
                >
            ...
            <TabsContent value="analytics" className="focus-visible:outline-hidden mt-0">
              {isLoadingAnalytics ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4">
                    <Card className="border border-slate-100 shadow-xs hover:border-blue-200 transition-colors bg-white dark:border-slate-800 dark:bg-slate-900">
                      <CardContent className="p-5 flex flex-col gap-3">
                        <div className="w-9 h-9 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center shrink-0 dark:bg-blue-950/30 dark:text-blue-400">
                    ...
                    <Card className="border border-slate-100 shadow-xs hover:border-purple-200 transition-colors bg-white dark:border-slate-800 dark:bg-slate-900">
                      <CardContent className="p-5 flex flex-col gap-3">
                        <div className="w-9 h-9 rounded-lg bg-purple-50 text-purple-600 flex items-center justify-center shrink-0 dark:bg-purple-950/30 dark:text-purple-400">
                    ...
                    <Card className="border border-slate-100 shadow-xs hover:border-green-200 transition-colors bg-white dark:border-slate-800 dark:bg-slate-900">
                      <CardContent className="p-5 flex flex-col gap-3">
                        <div className="w-9 h-9 rounded-lg bg-green-50 text-green-600 flex items-center justify-center shrink-0 dark:bg-green-950/30 dark:text-green-400">
                    ...
                    <Card className="border border-slate-100 shadow-xs hover:border-pink-200 transition-colors bg-white dark:border-slate-800 dark:bg-slate-900">
                      <CardContent className="p-5 flex flex-col gap-3">
                        <div className="w-9 h-9 rounded-lg bg-pink-50 text-pink-600 flex items-center justify-center shrink-0 dark:bg-pink-950/30 dark:text-pink-400">
                    ...
                    <Card className="border border-slate-100 shadow-xs hover:border-yellow-200 transition-colors bg-white dark:border-slate-800 dark:bg-slate-900">
                      <CardContent className="p-5 flex flex-col gap-3">
                        <div className="w-9 h-9 rounded-lg bg-yellow-50 text-yellow-600 flex items-center justify-center shrink-0 dark:bg-yellow-950/30 dark:text-yellow-400">
                  ...
                  <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3 dark:bg-amber-950/10 dark:border-amber-900/30">
                    <AlertCircle className="w-5 h-5 text-amber-500 shrink-0 mt-0.5 dark:text-amber-400" />
                    <div className="text-xs text-amber-800 leading-relaxed dark:text-amber-300">
        ...
        <div id="tour-youtube-profile" className="hidden lg:block lg:col-span-4 xl:col-span-3">
          <YouTubeChannelCard
              ...
              <div className="h-16 bg-slate-950/60 border border-white/5 rounded-xl flex items-center justify-center overflow-hidden relative">
                {activeTourSteps[tourStep - 1].indicator === 1 && (
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-red-500 uppercase font-bold tracking-wider animate-pulse">Monitoring YouTube Auth API</span>
                  </div>
                )}
                {activeTourSteps[tourStep - 1].indicator === 2 && (
                  <div className="flex items-center gap-2 text-[10px] font-bold text-purple-400">
                    <BarChart2 size={14} className="animate-bounce text-purple-400" />
                    <span>Real-time Live Summaries Active</span>
                  </div>
                )}
                {activeTourSteps[tourStep - 1].indicator === 3 && (
                  <div className="flex items-center gap-2">
                    <div className="w-2.5 h-2.5 rounded-full bg-blue-500 animate-ping" />
                    <span className="text-[10px] text-blue-400 font-bold uppercase tracking-wider">Sync Upload Queues</span>
                  </div>
                )}
              </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (tourStep < activeTourSteps.length) {
                        ...
                        localStorage.setItem("saadhyam_tour_youtube_completed", "true");
                      }
                    }}
                  >
