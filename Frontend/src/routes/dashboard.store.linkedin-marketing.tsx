...
export const Route = createFileRoute("/dashboard/store/linkedin-marketing")({
  head: () => ({
    meta: [{ title: "Store ΓÇö LinkedIn Marketing ΓÇö Saadhyam AI" }],
  }),
...
export function StoreLinkedInMarketingPage() {
  ...
  const handlePublishPost = async () => {
    ...
    try {
      ...
      if (response.success) {
        toast.success("≡ƒÄë Post published to your LinkedIn profile successfully!");
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    type="password"
                    placeholder={adminConfig?.is_secret_set ? "ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó (Leave blank to keep existing)" : "Enter LinkedIn Client Secret"}
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {companyName || brandName ? `${brandName || companyName} ΓÇó ${industry} ΓÇó ${tone}` : "Configure tone of voice, target audience, and brand defaults"}
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
          ...
          <Card className="border-border/80 shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  id="keyPoints"
                  placeholder="ΓÇó Faster implementation&#10;ΓÇó Reduced manual errors&#10;ΓÇó 3x ROI in 60 days"
                  value={keyPoints}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  ...
                  <span>{generatedText.length} characters ΓÇó ~{Math.ceil(generatedText.split(/\s+/).filter(Boolean).length)} words</span>
                </div>
                <Textarea
                  id="postEditor"
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-muted-foreground leading-tight">
                        {brandName || companyName || "Founder & Leader"} ΓÇó Just now ΓÇó ≡ƒîÉ
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-border/50 pt-2 flex items-center justify-between text-muted-foreground text-xs">
                    <div className="flex items-center gap-1">
                      <span className="flex -space-x-1">
                        <span className="w-4 h-4 rounded-full bg-[#0A66C2] text-white flex items-center justify-center text-[8px]">≡ƒæì</span>
                        <span className="w-4 h-4 rounded-full bg-red-500 text-white flex items-center justify-center text-[8px]">Γ¥ñ∩╕Å</span>
                        <span className="w-4 h-4 rounded-full bg-emerald-500 text-white flex items-center justify-center text-[8px]">≡ƒÆí</span>
                      </span>
                      <span className="text-[11px] text-muted-foreground/80 ml-1">42 reactions</span>
                    </div>
                    <span className="text-[11px] text-muted-foreground/80">8 comments ΓÇó 2 reposts</span>
                  </div>
