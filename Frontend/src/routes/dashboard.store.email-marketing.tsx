...
export const Route = createFileRoute("/dashboard/store/email-marketing")({
  head: () => ({
    meta: [{ title: "Store ΓÇö Email Marketing ΓÇö Saadhyam AI" }],
  }),
          ...
          <Card className="border-border/60 shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              {testSuccess !== null && (
                ...
                >
                  {testSuccess ? "Γ£à SMTP server connection verified successfully!" : "Γ¥î Connection test failed. Please verify credentials."}
                </div>
              )}
            </CardContent>
          </Card>
