  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground shadow-glow hover:shadow-floating hover:brightness-110",
        gradient: "bg-gradient-brand text-primary-foreground shadow-glow hover:brightness-110",
        destructive:
          "bg-destructive text-destructive-foreground shadow-soft hover:bg-destructive/90",
        outline:
          "border border-border bg-background/50 backdrop-blur-sm hover:bg-accent/30 hover:border-primary/40",
      ...
      size: {
        ...
        sm: "h-6 rounded-lg px-2.5 text-xs",
        lg: "h-10 rounded-xl px-6 text-sm",
        xl: "h-11 rounded-2xl px-8 text-sm",
        icon: "h-8 w-8",
      },
    },
    defaultVariants: {
