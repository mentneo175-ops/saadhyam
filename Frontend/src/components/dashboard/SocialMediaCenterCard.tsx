...
export function SocialMediaCenterCard() {
  ...
  if (loading) {
    return (
      <div className="relative overflow-hidden bg-white rounded-2xl border border-purple-200/50 shadow-xl shadow-purple-200/50 h-full flex flex-col min-h-[460px]">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-50/50 to-pink-50/30"></div>
        <div className="relative z-10 p-6 flex flex-col flex-1">
          {/* Header */}
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-bold text-lg text-gray-900">Social Media Center</h3>
          </div>
  ...
  return (
    <div className="group relative overflow-hidden bg-white rounded-2xl border border-purple-200/50 shadow-xl shadow-purple-200/50 hover:shadow-2xl hover:shadow-purple-300/50 transition-all duration-300 h-full flex flex-col min-h-[460px]">
      ...
      <div className="relative z-10 p-6 flex-1 flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="inline-flex rounded-xl bg-slate-100/80 p-1 border border-slate-200 self-start sm:self-auto">
            <button
            ...
            >
              {!instagramConnected ? (
                ...
                <div className="flex-1 flex flex-col justify-center text-center py-6">
                  ...
                  <p className="text-sm text-gray-700 font-semibold mb-2">Connect Instagram</p>
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-4 bg-white/55 p-3 rounded-xl border border-purple-100">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-sm text-slate-800">@{instagramStats?.username}</span>
                      </div>
                    ...
                    {instagramStats?.recent_post && (
                      <div className="bg-white/60 rounded-xl p-3 border border-purple-50 mb-4 text-left">
                        <div className="flex items-center gap-1.5 mb-1.5">
                          ...
                          <span className="text-[10px] font-bold text-slate-700">Latest Post</span>
                        </div>
            ...
            >
              {!youtubeConnected ? (
                ...
                <div className="flex-1 flex flex-col justify-center text-center py-6">
                  ...
                  <p className="text-sm text-gray-700 font-semibold mb-2">Connect YouTube</p>
                  <p className="text-xs text-gray-500 mb-6 max-w-xs mx-auto leading-relaxed">
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      ...
                      <div className="bg-white/70 backdrop-blur-sm rounded-xl p-3.5 border border-slate-100 hover:border-slate-300 transition-all">
                        <div className="flex items-center gap-1.5 mb-1">
                    ...
                    {youtubeStats?.latest_video && (
                      <div className="bg-white/60 rounded-xl p-3 border border-red-50 mb-4 text-left">
                        <div className="flex items-center gap-1.5 mb-1.5">
                          ...
                          <span className="text-[10px] font-bold text-slate-700">Latest Video</span>
                        </div>
                        <p className="text-xs text-slate-600 line-clamp-2 leading-relaxed mb-2">
