...
function PluginsPage() {
  ...
  const tourStepsConfig = [
    {
      id: "tour-plugins-tabs",
      title: "Tab Navigation",
      heading: "1. Store vs. Active Hub",
      desc: "Switch between finding new plugins, controlling active plugin automations, or accessing the developer portal.",
      indicator: 1
    },
    {
      id: "tour-plugins-intro",
      title: "Introduction Walkthrough",
      heading: "2. Video Guided Setup",
      desc: "Watch our interactive video to see how automated AI nodes pass messages to perform business tasks.",
      indicator: 2
    },
    {
      id: "tour-plugins-recommendations",
      title: "Smart AI Matching",
      heading: "3. Auto-Recommended Plugins",
      desc: "Select your company's vertical business category to get tailor-made suggestions selected by Saadhyam AI.",
      indicator: 3
    },
    {
      id: "tour-plugins-filters",
      title: "Marketplace Search",
      heading: "4. Filter Categories",
      desc: "Search by plugin name, or filter by category: Operations, Marketing, or Developer tools.",
      indicator: 4
    },
    {
      id: "tour-plugins-grid",
      title: "Plugin Cards Marketplace",
      heading: "5. Install & Run Flows",
      desc: "Browse detailed blueprints of each plugin, check required APIs, DDL databases, and click to install.",
      indicator: 5
    }
  ];
  ...
  useEffect(() => {
    const isCompleted = localStorage.getItem("saadhyam_tour_plugins_completed");
    if (!isCompleted) {
    ...
    <div className="p-4 md:p-6 bg-slate-950 text-slate-100 min-h-screen space-y-6 dark:bg-slate-900">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between border-b border-slate-900 pb-5 dark:border-slate-700">
        ...
        <div className="flex items-center gap-3 self-start">
          ...
          {/* Tab Controls */}
          <div id="tour-plugins-tabs" className="flex bg-slate-900 p-1 rounded-xl border border-slate-800 dark:bg-slate-900 dark:border-slate-700">
            <button
      ...
      {activeTab === "store" && (
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div id="tour-plugins-intro" className="lg:col-span-2 bg-slate-900/60 border border-slate-800 rounded-2xl p-6 shadow-md relative overflow-hidden flex flex-col justify-between backdrop-blur-md dark:border-slate-700">
            ...
            <div id="tour-plugins-recommendations" className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 shadow-md relative overflow-hidden backdrop-blur-md flex flex-col justify-between dark:border-slate-700">
              <div className="space-y-4">
          ...
          <div className="space-y-4 pt-4">
            <div id="tour-plugins-filters" className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between bg-slate-900/40 p-4 border border-slate-900 rounded-2xl dark:border-slate-700">
              {/* Category filters */}
            ...
            {/* Marketplace Grid */}
            <div id="tour-plugins-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="h-16 bg-slate-950/60 border border-white/5 rounded-xl flex items-center justify-center overflow-hidden relative">
                {activeTourSteps[tourStep - 1].indicator === 1 && (
                  <div className="flex items-center gap-2 text-[10px] font-bold text-purple-400">
                    <Puzzle size={14} className="animate-spin text-purple-400" />
                    <span>Workspace router ready</span>
                  </div>
                )}
                {activeTourSteps[tourStep - 1].indicator === 2 && (
                  <div className="flex items-center gap-2 text-[10px] font-bold text-purple-400">
                    <Video size={14} className="animate-pulse text-purple-400" />
                    <span>Walkthrough player ready</span>
                  </div>
                )}
                {activeTourSteps[tourStep - 1].indicator === 3 && (
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-purple-400 uppercase font-bold tracking-wider animate-pulse">Running AI Recommender</span>
                  </div>
                )}
                {activeTourSteps[tourStep - 1].indicator === 4 && (
                  <div className="flex items-center gap-2 text-[10px] font-bold text-purple-400">
                    <Search size={14} className="animate-bounce text-purple-400" />
                    <span>Filter index active</span>
                  </div>
                )}
                {activeTourSteps[tourStep - 1].indicator === 5 && (
                  <div className="flex items-center gap-2">
                    <div className="w-2.5 h-2.5 rounded-full bg-blue-500 animate-ping" />
                    <span className="text-[10px] text-blue-400 font-bold uppercase tracking-wider">Sync local setups</span>
                  </div>
                )}
              </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (tourStep < activeTourSteps.length) {
                        ...
                        localStorage.setItem("saadhyam_tour_plugins_completed", "true");
                      }
                    }}
                  >
